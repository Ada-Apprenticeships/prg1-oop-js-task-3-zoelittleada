  ...
  describe("OOP function tests", () => {
    ...
    describe('validPositiveInteger()',() => {
      test("T01 should check that input is a valid positive integer", () => {
        expect(validInteger(10)).toBe(true);
        expect(validInteger('10')).toBe(true);
    
        expect(validInteger(25)).toBe(true);
        expect(validInteger('25')).toBe(true);
  
        expect(validInteger(100)).toBe(true);
        expect(validInteger('100')).toBe(true);
        
        expect(validInteger(3)).toBe(true);
        expect(validInteger('3')).toBe(true);
    
        expect(validInteger(-100)).toBe(false);
        expect(validInteger(-25)).toBe(false)
        ...
        expect(validInteger('-0')).toBe(false);
        expect(validInteger('A')).toBe(false);
        expect(validInteger('0A')).toBe(false);
        expect(validInteger('1.0')).toBe(false);
